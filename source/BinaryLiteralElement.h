...
#ifndef __BinaryLiteralElement_h
#define __BinaryLiteralElement_h


class BinaryLiteralElement : public LiteralElement
{
	Cql_Binary value_;

public :

	BinaryLiteralElement( void );
	~BinaryLiteralElement( void );
...
typedef BinaryLiteralElement *pBinaryLiteralElement;


#endif  //  __BinaryLiteralElement_h
