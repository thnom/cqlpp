...
#ifndef __StringUCElement_h
#define __StringUCElement_h


class StringUCElement : public LiteralElement
{
	Cql_CharUC *concreteValue_;

	Cql_Char *charValue(AbstractValueElement&);

public :

	StringUCElement(void);
	~StringUCElement( void );
	...
	Cql_CharUC *concreteValue() { return concreteValue_; }
...
typedef StringUCElement *pStringUCElement;


#endif  //  __StringUCElement_h
